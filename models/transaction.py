...
class Transaction(db.Model):
    ...
    events_id = db.Column(db.Integer, db.ForeignKey("events.events_id"), nullable=False, index=True)
    transaction_name = db.Column(db.String(255), nullable=True)
    transaction_date = db.Column(db.DateTime, nullable=True, index=True)
