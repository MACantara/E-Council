/**
 * Minutes of the Meeting Overview Page JavaScript
 * Handles meeting status updates
 */

document.addEventListener('DOMContentLoaded', function () {
    initializeMeetingStatusUpdates();
});

function initializeMeetingStatusUpdates() {
    ...
    selects.forEach(select => {
        select.addEventListener('change', function () {
            ...
            fetch(`/meetings/update-minutes-of-the-meeting-status/${meetingId}`, {
                method: 'POST',
                headers: {
