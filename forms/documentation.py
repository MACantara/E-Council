...
class DocumentationForm(FlaskForm):
    ...
    def __init__(self, events=None, users=None, signatories=None, activity_reports=None, learning_journals=None, **kwargs):
        super().__init__(**kwargs)
        if events is not None:
            self.documentation_events_id.choices = (
                [('', 'Select Event')] +
        ...
        if activity_reports is not None:
            self.documentation_activity_report_forms_id.choices = (
                [('', 'Select Activity Report Form')] +
                [(str(ar.activity_report_forms_id), ar.activity_report_forms_nature_of_the_activity) for ar in activity_reports]
            )
        if learning_journals is not None:
            self.documentation_learning_journal_forms_id.choices = (
                [('', 'Select Learning Journal Form')] +
