...
from wtforms import StringField, SelectField, TextAreaField, DateTimeField, FloatField, FileField as WTFileField
from wtforms.validators import InputRequired, Optional

from forms.validators import coerce_int, coerce_float
...
class EventForm(FlaskForm):
    ...
    def __init__(self, concept_papers=None, academic_years=None, **kwargs):
        ...
        if concept_papers is not None:
            self.concept_paper_forms_id.choices = (
                [('', 'Select a Concept Paper')] +
