...
class TestConfigClasses:
    ...
    def test_development_config(self):
        ...
        assert not DevelopmentConfig.TESTING
        assert not DevelopmentConfig.SESSION_COOKIE_SECURE

    def test_production_config(self):
        """Test production configuration."""
        assert not ProductionConfig.DEBUG
        assert not ProductionConfig.TESTING
        assert ProductionConfig.SESSION_COOKIE_SECURE
    ...
    def test_database_config(self):
        ...
        assert not DatabaseConfig.SQLALCHEMY_TRACK_MODIFICATIONS
    ...
    def test_cloudinary_config(self):
        ...
        assert CloudinaryConfig.CLOUDINARY_SECURE
...
class TestConfigIntegration:
    ...
    def test_database_uri_from_env(self):
        ...
        assert (
            "mysql://" in DatabaseConfig.SQLALCHEMY_DATABASE_URI
            or "sqlite://" in DatabaseConfig.SQLALCHEMY_DATABASE_URI
        )
