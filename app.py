...
@app.route("/concept-paper-generation", methods=["GET", "POST"])
def concept_paper_generation():
    if request.method == "POST":
        ...
        return render_template("concept-paper-generation.html", download_link=response_filename)
    return render_template("concept-paper-generation.html")
